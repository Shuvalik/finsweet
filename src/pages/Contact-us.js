                ...
                <div className="titleSectionHolder pixelOrange">
                    ...
                    <form action="/" id="contact">
                        ...
                        <div className="stylishCornerTreeColor">
                            <button type="submit" className="btn arrowLink">Send Messege</button>
                        </div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <p>
                                    ...
                                    <span className="addInfo">Our Support Team is available 24Hrs</span>
                                </p> 
                            </li>
                            <li>
                                <p className="partTitle">
                                ...
                                <p>
                                    <span><a href="tel:020 7993 2905">020 7993 2905</a></span>
                                    <span className="addInfo"><a href="mailto:hi@finsweet.com">hi@finsweet.com</a></span> 
                                </p>
